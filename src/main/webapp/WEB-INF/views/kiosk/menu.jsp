...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            let cart = getCartCookie();  // 쿠키에서 장바구니 데이터 로드
            ...
            window.addToCart = function(menuId) {
                ...
                setCartCookie(cart);  // 장바구니 쿠키 업데이트
                updateCartDisplay();
            }
            ...
            // 장바구니 데이터를 쿠키에 저장하는 함수
            function setCartCookie(cart) {
                const cartData = JSON.stringify(cart);
                document.cookie = "cartData=" + encodeURIComponent(cartData) + "; path=/";
            }

            // 쿠키에서 장바구니 데이터를 읽어오는 함수
            ...
            loadCart();  // 페이지 로드 시 장바구니 복원
            // 폼 제출 시 장바구니 데이터를 서버로 전송
        ...
        function decreaseQuantity(menuId) {
            ...
            if (found) {
                if (found.quantity > 1) {
                    ...
                    cart = cart.filter(item => item.menuId !== menuId); // 수량이 1이면 아이템 삭제
                }
                setCartCookie(cart);
                updateCartDisplay();
            }
...
<div id="kiosk-container">
    ...
    <div id="cart-section" style="display: none;">
        ...
        <form id="cart-form" action="/kiosk/details" method="post">
